...
def getFileName():
    ...
    file = f"{world.model_name}-{world.dataset}-{dim}-Tau{world.config['tau_model2']}-alpha{world.config['alpha_model2']}-drop{world.config['dropout_model2']}-lr{world.config['vae_lr']}-reg{world.config['vae_reg_param']}-FP{world.config['FP']}-FN{world.config['FP']}-WScale{world.config['weight_scale']}.pth.tar"
